...
@section('title', 'Jasa SEO & Sosial Media Ads')
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between">
                ...
                <div class="w-full lg:w-3/5 text-white space-y-8 hero-content">
                    <h1 class="text-5xl md:text-7xl font-bold leading-tight">
                        ...
                        <span class="hero-title-word block">LAYANAN</span>
                        <span class="hero-title-word block text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-purple-400">SEO & </span>
                        <span class="hero-title-word block text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-purple-400">SOSIAL MEDIA ADS</span>
                    </h1>                    
                    <p class="text-xl md:text-2xl text-blue-100 opacity-90 max-w-2xl hero-description">
                        Optimasikan Website bisnis anda dan juga kembangkan digital marketing melalui sosial media ads untuk meningkatkan value bisnis.
                    </p>
                </div>
            </div>
        </div>
...
<section id="layanan" class="py-20 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16 fade-in">
            <h2 class="text-4xl font-bold mb-4">Layanan Jasa SEO & Sosial Media Ads</h2>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">Solusi meningkatkan branding digital marketing bisnis anda</p>
        </div>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">Temukan solusi untuk layanan SEO & Sosmed Ads</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-lg p-8 text-center hover:scale-105 transition-transform duration-300">
                ...
                <ul class="mb-8 space-y-4 text-gray-600">
                    <li>Audit SEO dasar & riset kata kunci ringan</li>
                    <li>Optimasi meta tag 1 halaman</li>
                    <li>Setup iklan FB/IG dengan desain sederhana</li>
                    <li>1x penjadwalan iklan & evaluasi performa awal</li>
                </ul>
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-lg p-8 text-center hover:scale-105 transition-transform duration-300 transform">
                ...
                <div class="mb-6">
                    <span class="text-4xl font-bold">Mulai dari<br>Rp 800.000</span>
                </div>
                <ul class="mb-8 space-y-4 text-gray-600">
                   <li>Audit SEO teknis & optimasi hingga 5 halaman</li>
                    <li>Riset kata kunci & backlink dasar</li>
                    <li>Manajemen iklan di FB & IG dengan desain profesional</li>
                    <li>3x optimasi iklan & laporan performa bulanan</li>
                </ul>
                <button class="w-full bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-700 transition-colors">
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-lg p-8 text-center hover:scale-105 transition-transform duration-300">
                ...
                <ul class="mb-8 space-y-4 text-gray-600">
                    <li>Strategi SEO menyeluruh & konten SEO bulanan</li>
                    <li>Optimasi semua halaman & backlink premium</li>
                    <li>Iklan multi-platform (FB, IG, TikTok) dengan A/B testing</li>
                    <li>Dukungan prioritas & laporan mingguan</li>
                </ul>
                <button class="w-full bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-700 transition-colors">
                    Hubungi Tim Kami
                </button>
                ...
                <div class="inner-card bg-gradient-to-br from-indigo-900/50 to-purple-900/50 rounded-2xl p-8 md:p-12">
                    <div class="text-center mb-10">
                        <h2 class="cta-title text-4xl md:text-5xl font-bold mb-6 text-white">
                            <span class="inline-block">Siap Optimasikan</span>
                            <span class="inline-block ml-2 relative">
                                branding digital marketing bisnis anda?
                            </span>
                        </h2>
                        <p class="cta-description text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
                            Konsultasikan kebutuhan Anda dengan tim ahli kami dan dapatkan solusi terbaik.
                        </p>
                    </div>
